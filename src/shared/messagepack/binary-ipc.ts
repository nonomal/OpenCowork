...
export const DB_MESSAGES_WINDOW_INDEX_MSGPACK_CHANNEL = 'db:messages:window-index:msgpack'
export const DB_MESSAGES_RANGE_MSGPACK_CHANNEL = 'db:messages:range:msgpack'
export const DB_MESSAGES_CONTENT_MSGPACK_CHANNEL = 'db:messages:content:msgpack'
...
export const DB_SESSIONS_LIST_PAGE_MSGPACK_CHANNEL = 'db:sessions:list-page:msgpack'
