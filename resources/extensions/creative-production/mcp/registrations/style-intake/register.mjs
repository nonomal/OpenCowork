...
export function registerStyleIntakeWidget(server) {
  const html = inlineWidget({
    html: readText(pluginPath("mcp", "widget-assets", "style-intake", "widget.html")),
    css: readText(pluginPath("mcp", "widget-assets", "keyword-intake", "widget.css")),
    js: readText(pluginPath("mcp", "widget-assets", "keyword-intake", "widget.js")),
  ...
  return [
    {
      ...
      options: ["Quiet luxury", "Heritage craft", "Editorial modern", "Warm natural", "Fresh modern", "Deep atmospheric", "Grand occasion", "Daylight refined"],
    },
    {
      id: "visual_language",
      title: "What should shape the visual language?",
      options: ["Soft shadow", "Natural texture", "Brass", "Marble", "Rich upholstery", "Warm metal", "Glassware", "Fresh botanicals", "Product detail", "Hands in use", "Night exterior", "Daylight setting"],
    },
    {
      id: "typography",
    ...
    },
    {
      ...
      options: ["Burgundy cream gold", "Green cream brass", "Deep amber charcoal", "Copper ivory charcoal", "Daylight cream sage", "Black gold white"],
    },
    {
      id: "avoid",
      title: "What should the style avoid?",
      options: ["Category cliches", "Fake luxury", "Overly formal", "Generic stock", "Too rustic", "Too sterile", "Trendy neon", "Crowded layouts"],
    },
  ];
}
