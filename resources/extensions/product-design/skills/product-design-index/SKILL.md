...
Use [$user-context](../product-design-user-context/SKILL.md) when the user asks to:
...
Before routing to Product Design workflows, load [$user-context](../product-design-user-context/SKILL.md) and run its preflight script when local shell access is available.
