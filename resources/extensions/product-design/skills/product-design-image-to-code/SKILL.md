...
0. Do not start unless `$get-context` has played back and confirmed the design brief for this exact request. If this skill was directly at-mentioned without a clear visual target or the current thread does not already contain a confirmed brief, route to [$get-context](../product-design-get-context/SKILL.md) first.
...
11. Run [design-qa](../product-design-design-qa/SKILL.md) as the blocking build gate.
